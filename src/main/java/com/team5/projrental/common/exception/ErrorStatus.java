...
public enum ErrorStatus {
    ...
    CAN_NOT_BLANK_EX_MESSAGE(486),
    AUTHENTICATION_FAIL_EX_MESSAGE(483),
    CAN_NOT_DEL_USER_EX_MESSAGE(482),
    REVIEW_ALREADY_EXISTS_EX_MESSAGE(481),
    //
    ...
    NO_SUCH_REVIEW_EX_MESSAGE(474),
    BAD_PRODUCT_ISTATUS_EX_MESSAGE(473),
    //
