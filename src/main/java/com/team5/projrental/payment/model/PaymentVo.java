...
public class PaymentVo extends PaymentListVo {
    ...
    public PaymentVo(String nick, Resource userPic, Integer ipayment, Integer iproduct, String status,
        ...
        super(nick, userPic, ipayment, iproduct, status, rentalStartDate, rentalEndDate, rentalDuration, price, deposit);
        this.phone = phone;
